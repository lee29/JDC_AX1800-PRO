...
remove_NoPasswordSet() {
    ...
    install -Dm755 "$GITHUB_WORKSPACE/patches/luci-theme-aurora-header.ut" "$OPENWRT_PATH/package/feeds/luci/luci-theme-aurora/ucode/template/themes/argon/header.ut" 
}
